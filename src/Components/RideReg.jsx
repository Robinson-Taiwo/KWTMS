        ...
        <div className='ride-reg' >
            ...
            <div className="ride-form">
                ...
                <form className="ride-reg-form">
                    ...
                    <button disabled={!name || !number || !idNumber || !chasesNumber || !selectedOption || !selectedRegistration || !selectedOwnership} onClick={handleSubmit} className="ride-button">
                        submit Data
                    </button>
